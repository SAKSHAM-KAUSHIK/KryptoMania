...
function CryptoDetails() {
  ...
  const { data: coinHistory, isFetching1 } = useGetCryptoHistoryQuery({ coinId, timePeriod });
    ...
    <Col className="coin-detail-container">
      <Col className='coin-heading-container'>
        <Title level={2} className="coin-name">
          {<img className='crypto-detail-image' src={cryptoDetails.iconUrl} />}  {cryptoDetails.name}
        </Title>
        <p>
